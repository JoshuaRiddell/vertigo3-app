...
export default function PauseButton({ active, handler }) {
  return (
    <span className="video-icon-wrapper pause-icon-wrapper" onClick={handler}>
      ...
      >
        ...
        <g
          id="Group_152"
          data-name="Group 152"
          transform="translate(30.174 27.018)"
        >
          <path
            id="Path_113"
            data-name="Path 113"
            d="M706.453,171.649a3.433,3.433,0,0,1-3.433-3.433V151.053a3.433,3.433,0,0,1,6.866,0v17.164A3.433,3.433,0,0,1,706.453,171.649Z"
            transform="translate(-689.976 -147.62)"
            fill={active ? "#e06c22" : "#fff"}
          />
          <path
            id="Path_114"
            data-name="Path 114"
            d="M683.653,171.649a3.432,3.432,0,0,1-3.433-3.433V151.053a3.433,3.433,0,1,1,6.865,0v17.164A3.432,3.432,0,0,1,683.653,171.649Z"
            transform="translate(-680.22 -147.62)"
            fill={active ? "#e06c22" : "#fff"}
          />
        </g>
      </svg>

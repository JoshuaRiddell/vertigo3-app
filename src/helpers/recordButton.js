...
export default function recordButton({ active, handler }) {
  return (
    <span className="video-icon-wrapper record-icon-wrapper" onClick={handler}>
      {/* <img src={recordIcon} className="video-icon record-icon" /> */}
      <svg
        id="Group_175"
        data-name="Group 175"
      ...
      >
        ...
        />
        <rect
          className={`record-btn ${active ? "record-pulse" : ""}`}
          id="Rectangle_3"
          data-name="Rectangle 3"
          width="21.426"
          height="21.426"
          rx="10.713"
          transform="translate(29.185 29.185)"
          fill="#fff"
        />
      </svg>
    </span>
